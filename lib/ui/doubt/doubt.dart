...
import 'package:rts/widgets/other_side_message.dart';
import 'package:rts/widgets/own_message.dart';
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () {
                    Clipboard.setData(
                      ClipboardData(
                          text: vm.chatList[vm.selectedIndex!].message),
                    );
                    vm.showBottomNavigation = false;
                    vm.update();
                ...
                ListTile(
                  ...
                  leading: Icon(
                    vm.chatList[vm.selectedIndex!].isPinned
                        ? Icons.star
                        : Icons.star_border,
                    color: vm.chatList[vm.selectedIndex!].isPinned
                        ? Colors.yellow
                        : Colors.white,
                  ),
                  onTap: () {
